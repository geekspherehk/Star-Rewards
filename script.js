...
// ── 徽章徽记：每枚专属形制 + 主题图形 + 双色渐变（分层设计，非通用描边图标）──
// ── 徽章徽记：每枚专属形制（星/盾/币/六边/太阳/火焰/叶/调色/玫瑰结…）+ 主题图形 + 双色渐变 ──
const V2_BADGE_SVGS = {
    self_drive: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_self_drive" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#8B7BFF"/><stop offset="100%" stop-color="#5B46E5"/></linearGradient></defs><path fill="url(#bg_self_drive)" d="M24 2l6 12.6 13.8 1.9-10 9.4 2.5 13.6L24 33.2l-12.3 6.3 2.5-13.6-10-9.4L18 14.6z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M24 14l2.6 5.4 6 .8-4.4 4.2 1.1 6-5.3-2.9-5.3 2.9 1.1-6-4.4-4.2 6-.8z"/></g></svg>',
    money: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_money" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#F5B95C"/><stop offset="100%" stop-color="#E08A2B"/></linearGradient></defs><circle cx="24" cy="24" r="22" fill="url(#bg_money)"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="24" cy="24" r="7"/><path d="M21 20h6M21 28h6M24 17v14"/></g></svg>',
    empathy: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_empathy" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FF8FA8"/><stop offset="100%" stop-color="#E64C6B"/></linearGradient></defs><circle cx="24" cy="20" r="16" fill="url(#bg_empathy)"/><path fill="url(#bg_empathy)" opacity="0.8" d="M12 34l-4 12 16-8 16 8-4-12z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M24 27S18 22 15 18a5 5 0 0 1 9-3 5 5 0 0 1 9 3c-3 4-9 9-9 9z"/></g></svg>',
    relationship: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_relationship" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FFC145"/><stop offset="100%" stop-color="#F0910F"/></linearGradient></defs><circle cx="24" cy="24" r="18" fill="url(#bg_relationship)"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="24" cy="24" r="5"/><path d="M24 12v3M24 33v3M12 24h3M33 24h3M15.5 15.5l2 2M30.5 30.5l2 2M32.5 15.5l-2 2M17.5 30.5l-2 2"/></g></svg>',
    planning: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_planning" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#6FC6F5"/><stop offset="100%" stop-color="#2F86D6"/></linearGradient></defs><path fill="url(#bg_planning)" d="M24 2l19 11v22L24 46 5 35V13z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="24" cy="24" r="8"/><circle cx="24" cy="24" r="3"/><path d="M24 16v3M24 29v3M16 24h3M29 24h3"/></g></svg>',
    resilience: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_resilience" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#7CD992"/><stop offset="100%" stop-color="#2FA35A"/></linearGradient></defs><path fill="url(#bg_resilience)" d="M24 2l19 6v14c0 12-8.5 20-19 24C13.5 42 5 34 5 22V8z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M18 20c3-2 5 3 8 1s3 5 0 7-6-2-8-4-3-3 0-4z"/><path d="M24 14v18"/></g></svg>',
    health: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_health" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#5FCB7E"/><stop offset="100%" stop-color="#1E9B57"/></linearGradient></defs><path fill="url(#bg_health)" d="M42 6C22 6 6 16 6 30c0 6 4 10 10 10 14 0 26-16 26-34z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M14 34c2-6 8-12 16-16-2 9-7 15-13 17z"/><path d="M18 18c1 4 3 7 6 9"/></g></svg>',
    aesthetics: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_aesthetics" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#C08BF5"/><stop offset="100%" stop-color="#8A45D6"/></linearGradient></defs><circle cx="24" cy="24" r="22" fill="url(#bg_aesthetics)"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M17 20l7 0 9 9-7 7-9-9z"/><circle cx="16" cy="16" r="2"/><circle cx="31" cy="17" r="2"/></g></svg>',
    all_rounder: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_all_rounder" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#A78BFA"/><stop offset="100%" stop-color="#6D3BE0"/></linearGradient></defs><path fill="url(#bg_all_rounder)" d="M24 1l3.2 4.4 5.3-1.6 1.2 5.4 5.4 1.1-1.6 5.3 4.4 3.2-4.4 3.2 1.6 5.3-5.4 1.1-1.2 5.4-5.3-1.6L24 47l-3.2-4.4-5.3 1.6-1.2-5.4-5.4-1.1 1.6-5.3L6 29l4.4-3.2-1.6-5.3 5.4-1.1 1.2-5.4 5.3 1.6z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="24" cy="24" r="7"/><path d="M24 10v4M24 34v4M10 24h4M34 24h4"/></g></svg>',
    streak3: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_streak3" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FFB25C"/><stop offset="100%" stop-color="#F2712C"/></linearGradient></defs><path fill="url(#bg_streak3)" d="M24 2c6 8 12 11 12 20a12 12 0 0 1-24 0c0-4 2-6 4-8 0 3 2 4 3 3-1-5 1-9 5-15z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M24 40c4 0 7-3 7-7 0-4-3-6-3-10 0 3-2 4-3 3-1-4 1-7 3-11-5 3-11 8-11 15 0 6 3 10 7 10z"/></g></svg>',
    streak7: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_streak7" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FFD25C"/><stop offset="100%" stop-color="#F0A00F"/></linearGradient></defs><path fill="url(#bg_streak7)" d="M24 2l19 11v22L24 46 5 35V13z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M26 12l-8 12h6l-2 12 9-13h-6z"/></g></svg>',
    persist_21: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_persist_21" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#6FC6F5"/><stop offset="100%" stop-color="#2F86D6"/></linearGradient></defs><rect x="5" y="9" width="38" height="34" rx="6" fill="url(#bg_persist_21)"/><rect x="5" y="9" width="38" height="10" rx="6" fill="url(#bg_persist_21)" opacity="0.7"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M14 26l5 5 10-10"/><path d="M17 13h14"/></g></svg>',
    wish1: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_wish1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#8FB8FF"/><stop offset="100%" stop-color="#3F6FD6"/></linearGradient></defs><path fill="url(#bg_wish1)" d="M10 2v44l14-6 14 6V2L24 8 10 2z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M17 14l7 4 7-4v14l-7 4-7-4z"/></g></svg>',
    wish3: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_wish3" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FFC98A"/><stop offset="100%" stop-color="#E08A2B"/></linearGradient></defs><circle cx="24" cy="20" r="15" fill="url(#bg_wish3)"/><path fill="url(#bg_wish3)" opacity="0.8" d="M17 32l-5 14 12-6 12 6-5-14z"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="24" cy="20" r="6"/><path d="M20 34l-2 8 6-4 6 4-2-8"/></g></svg>',
    wish10: '<svg class="bdg-art" viewBox="0 0 48 48" role="img"><defs><linearGradient id="bg_wish10" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FFD97A"/><stop offset="100%" stop-color="#E0A005"/></linearGradient></defs><path fill="url(#bg_wish10)" d="M12 4h24v10a12 12 0 0 1-24 0z"/><path fill="url(#bg_wish10)" opacity="0.85" d="M14 26h20l-3 8H17z"/><rect x="18" y="34" width="12" height="4" rx="2" fill="url(#bg_wish10)"/><g fill="none" stroke="rgba(255,255,255,.95)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M18 4h12v6a6 6 0 0 1-12 0z"/><path d="M20 26h8l-2 6h-4z"/></g></svg>',
...
function renderWeeklyReport() {
    ...
    let checkinCount = 0, pts = 0;
    (Array.isArray(checkins) ? checkins : []).forEach(c => {
        if (c.checkin_date >= monKey && c.checkin_date <= sunKey) { checkinCount++; pts += 5; }
    });
    (Array.isArray(behaviors) ? behaviors : []).forEach(b => {
        const d = new Date(b.timestamp);
        if (!isNaN(d)) {
    ...
    el.innerHTML =
        '<div class="ws-stat"><span class="ws-value">' + checkinCount + '</span><span class="ws-label">' + escapeHtml(t('v2.weeklyCheckins')) + '</span></div>' +
...
// 教育专栏：列出全部已有 SEO 文章 + 合集入口（2026-09-13 补全 6 篇入口，未登录也可见）
function renderEduColumn() {
    const el = document.getElementById('edu-cards');
    if (!el) return;
    // 文章链接跟随界面语言：英文读者看英文版；中文读者优先中文版，缺中文版则回退英文版
    const isEn = getLanguage() === 'en';
    const articles = [
        { title: t('home.eduArt1Title'), sub: t('home.eduArt1Sub'), zh: 'star-chart-guide.html', en: 'star-chart-guide-en.html' },
    ...
    let html = articles.map(a =>
        '<a class="edu-card" href="' + urlOf(a) + '" target="_blank" rel="noopener">' +
    ...
    html += '<a class="edu-card edu-card--all" href="' + (isEn ? 'guides-en.html' : 'guides.html') + '" target="_blank" rel="noopener">' +
        '<span class="edu-card-tag">' + escapeHtml(t('home.eduViewAll')) + '</span>' +
        '<h4 class="edu-card-title">' + escapeHtml(t('home.eduViewAllTitle')) + '</h4>' +
        '<p class="edu-card-sub">' + escapeHtml(t('home.eduViewAllSub')) + '</p>' +
        '<span class="edu-card-more">' + escapeHtml(t('home.eduViewAll')) + ' →</span>' +
    '</a>';
    el.innerHTML = html;
}
